...
# 安装脚本检测
VERSION_URL="https://raw.githubusercontent.com/nodepasscore/nodepass-core/refs/heads/main/internal/version.txt"
UPDATE_SCRIPT_URL="https://raw.githubusercontent.com/nodepasscore/nodepass-core/refs/heads/main/internal/update.sh"
...
E[22]="请复制以上参数填写到中转面板添加主控的URL以及KEY即可"
C[22]="${E[22]}"
